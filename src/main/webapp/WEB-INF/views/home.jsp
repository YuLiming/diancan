...
<head>
    ...
    <link rel="stylesheet" href="/vendor/css/bootstrap.min14ed.css"/>
    <link href="/vendor/css/font-awesome.min93e3.css?v=4.4.0" rel="stylesheet">
    <link href="/vendor/css/animate.min.css" rel="stylesheet">
    <link rel="stylesheet" href="/vendor/css/style.min862f.css"/>

    <script type="text/javascript" src="/vendor/js/plugins/echarts/echarts.min.js"></script>
</head>
<body class="gray-bg">
                        ...
                        <div class="col-sm-9">
                            <div class="flot-chart">
                                <div class="flot-chart-content" id="flot-dashboard-chart">
                                    <div id="main_orange" style="width: 100%;height:100%;"></div>
                                </div>
                            </div>
                        </div>
                        <div class="col-sm-3">
...
<script type="text/javascript">
    ...
    var myChart = echarts.init(document.getElementById('main_orange'));
...
<script src="/vendor/js/plugins/easypiechart/jquery.easypiechart.js"></script>
</body>
</html>